...
console.log("after the triming :",str);
...
const arr = [1,2,3,4,5];
console.log("after the isArray :",isArray(arr));
...
fruitArr.forEach(function(value,index){
...
const newArr = fruitArr1.map(function(value,index){
...
const newArr1 = fruitArr2.filter(function(value,index){
...
const newArr2 = fruitArr3.reduceRight(function(value,index){
    console.log(value,index);
    return value.length >= 5;
}
);
...
const newArr3 = digit.every(function(value,index){
...
const newArr4 = digit1.some(function(value,index){
...
const arr1 = [{name:"jim",age:26},{name:"john",age:25},{name:"lib",age:25}];
const newArr9 = arr1.reduceRight(function(acc,curr,index,arr){
